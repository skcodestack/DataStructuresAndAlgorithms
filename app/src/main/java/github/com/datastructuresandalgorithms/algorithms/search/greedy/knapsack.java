package github.com.datastructuresandalgorithms.algorithms.search.greedy;
...
public class knapsack {
    ...
    public void run(int capacity,int weights[],int[] values){
        ...
        System.out.println("总共放下的物品数量："+x.toString());
